...
public class UnmatchedForSeparation extends Unmatched_For {

    private For For;
    private Unmatched Unmatched;

    public UnmatchedForSeparation (For For, Unmatched Unmatched) {
        this.For=For;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("UnmatchedForSeparation(\n");
