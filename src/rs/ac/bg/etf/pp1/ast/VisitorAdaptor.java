...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(RelopMoreEq RelopMoreEq) { visit(); }
    public void visit(RelopMore RelopMore) { visit(); }
    public void visit(RelopDif RelopDif) { visit(); }
    public void visit(RelopEq RelopEq) { visit(); }
    public void visit(AssignopEq AssignopEq) { visit(); }
    ...
    public void visit(FactorNewNoExpr FactorNewNoExpr) { visit(); }
    ...
    public void visit(TermNoMulop TermNoMulop) { visit(); }
    public void visit(Terms Terms) { visit(); }
    public void visit(ExprTermNoAddop ExprTermNoAddop) { visit(); }
    public void visit(ExprListAddop ExprListAddop) { visit(); }
    ...
    public void visit(NoConditions NoConditions) { visit(); }
    public void visit(ConditionError ConditionError) { visit(); }
    public void visit(ConditionListNoOr ConditionListNoOr) { visit(); }
    public void visit(ConditionListOr ConditionListOr) { visit(); }
    public void visit(ActParsListNoComma ActParsListNoComma) { visit(); }
    public void visit(ActParsListComma ActParsListComma) { visit(); }
    ...
    public void visit(NoDesigStatement NoDesigStatement) { visit(); }
    public void visit(DesigStatementY DesigStatementY) { visit(); }
    ...
    public void visit(MatchedDesignatorError MatchedDesignatorError) { visit(); }
    ...
    public void visit(UnmatchedIfNoElse UnmatchedIfNoElse) { visit(); }
    public void visit(StatementUnatched StatementUnatched) { visit(); }
    ...
    public void visit(FormBrackets FormBrackets) { visit(); }
    public void visit(FormNoBrackets FormNoBrackets) { visit(); }
    public void visit(FormParametersListSingle FormParametersListSingle) { visit(); }
    ...
    public void visit(MethNameVoid MethNameVoid) { visit(); }
    public void visit(MethNameType MethNameType) { visit(); }
    ...
    public void visit(ConstantsPart ConstantsPart) { visit(); }
    public void visit(ConstantsListNoComma ConstantsListNoComma) { visit(); }
    public void visit(ConstantsListComma ConstantsListComma) { visit(); }
    public void visit(ConstantsDecl ConstantsDecl) { visit(); }
    public void visit(Declarations4 Declarations4) { visit(); }
    public void visit(Declarations3 Declarations3) { visit(); }
    public void visit(Declarations2 Declarations2) { visit(); }
